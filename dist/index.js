...
function Table({
  ...
  const paginationButtonClass = "flex h-8 w-8 items-center justify-center rounded-none border border-[#CBD5E1] bg-white text-xs text-[#64748B] transition-colors hover:bg-slate-50 disabled:opacity-40";
    ...
    enablePagination && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-3 items-center border-t border-[#CBD5E1] bg-white px-2 py-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-center gap-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-2 text-[11px] text-slate-500", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "flex h-8 min-w-8 items-center justify-center rounded-none border border-[#CBD5E1] bg-white px-2 font-semibold text-black", children: currentPage }),
