...
function Table({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-full overflow-hidden border-2 border-[#E5E7EB] bg-white font-[Inter,sans-serif]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative flex items-center border-t border-[#E5E7EB] bg-white px-5 py-4", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "absolute left-1/2 flex -translate-x-1/2 flex items-center gap-3 text-sm text-[#64748B]", children: [
